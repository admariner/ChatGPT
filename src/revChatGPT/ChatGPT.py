...
class Chatbot:
    ...
    def solve_captcha(self) -> str:
        ...
        if "code" in solved_captcha:
            print(f"{self.GREEN}Captcha solved successfully!{self.ENDCOLOR}")
            if self.verbose:
                print(
                    self.GREEN
                    + "Captcha token: "
    ...
    def detect_cookies(self, message):
        ...
        if (
            ...
            if cf_clearance_cookie and not self.cf_cookie_found:
                ...
                if self.verbose:
                    print(f"{self.GREEN}Cloudflare Cookie: {self.ENDCOLOR}{self.cf_clearance}")
            ...
            if session_cookie and not self.session_cookie_found:
                ...
                if self.verbose:
                    print(f"{self.GREEN}Session Token: {self.ENDCOLOR}{self.session_token}")
